...
#[rustfmt::skip]
impl TestGameApp {
    pub fn new(ws_port: u16, wasm: &[u8], params: &[u8], own_id: bevy_freenet::boxes::PlayerId, own_entry: bevy_freenet::roster::PeerEntry) -> Self {
    ...
    pub fn box_spawns(&mut self) -> Vec<(bevy_freenet::boxes::PlayerId, bevy::math::Vec2, bool)> { tga_method::box_spawns(self) }
