...
use mainnet_automation_2::Error;
use mainnet_automation_2::build_game;
use mainnet_automation_2::build_report;
use mainnet_automation_2::evaluate;
use mainnet_automation_2::find_window_by_pid;
use mainnet_automation_2::finish_record;
use mainnet_automation_2::jump_instance;
use mainnet_automation_2::kill_all_instances;
use mainnet_automation_2::launch_instances;
use mainnet_automation_2::list_windows;
use mainnet_automation_2::load_creds;
use mainnet_automation_2::move_instance;
use mainnet_automation_2::new_run_dir;
use mainnet_automation_2::parse_config;
use mainnet_automation_2::send_text;
use mainnet_automation_2::send_video;
use mainnet_automation_2::start_record;
use mainnet_automation_2::tile_windows;
use mainnet_automation_2::wait_all_converged;
use mainnet_automation_2::window_info::WindowInfo;
...
// needed helper:
fn find_windows(
    instances: &[mainnet_automation_2::instance::Instance],
