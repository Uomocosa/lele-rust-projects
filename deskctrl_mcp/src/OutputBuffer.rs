...
#[rustfmt::skip]
impl OutputBuffer {
    pub fn push(&mut self, line: &str) { crate::OutputBufferMethod::push(self, line) }
    pub fn take_new(&mut self) -> String { crate::OutputBufferMethod::take_new(self) }
    pub fn find_line(&self, pattern: &str) -> Option<String> { crate::OutputBufferMethod::find_line(self, pattern) }
