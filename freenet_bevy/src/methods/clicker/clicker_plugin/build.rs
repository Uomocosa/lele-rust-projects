...
use crate::structs::clicker::clicker_plugin::ClickerPlugin;
use crate::structs::clicker::clicker_state::ClickerState;
use crate::structs::clicker::count_changed::CountChanged;
...
pub fn build(plugin: &ClickerPlugin, app: &mut App) {
    ...
    app.add_systems(
        Update,
        crate::system::clicker::poll_freenet_events::poll_freenet_events,
    );
}
