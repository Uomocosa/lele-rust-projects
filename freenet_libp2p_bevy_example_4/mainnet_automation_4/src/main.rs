...
use mainnet_automation_4::Error;
use mainnet_automation_4::build_game;
use mainnet_automation_4::build_report;
use mainnet_automation_4::evaluate;
use mainnet_automation_4::find_window_by_pid;
use mainnet_automation_4::finish_record;
use mainnet_automation_4::jump_instance;
use mainnet_automation_4::kill_all_instances;
use mainnet_automation_4::launch_instances;
use mainnet_automation_4::list_windows;
use mainnet_automation_4::load_creds;
use mainnet_automation_4::move_instance;
use mainnet_automation_4::new_run_dir;
use mainnet_automation_4::parse_config;
use mainnet_automation_4::send_text;
use mainnet_automation_4::send_video;
use mainnet_automation_4::start_record;
use mainnet_automation_4::tile_windows;
use mainnet_automation_4::wait_all_converged;
use mainnet_automation_4::window_info::WindowInfo;
...
// needed helper:
fn find_windows(
    instances: &[mainnet_automation_4::instance::Instance],
