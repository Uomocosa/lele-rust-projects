...
impl ProductionGameApp {
    ...
    pub fn roster_ids(&self) -> Vec<freenet_libp2p_bevy_example_4_lib::boxes::PlayerId> { methods::production_game_app::roster_ids(self) }
    pub fn own_player_id(&self) -> freenet_libp2p_bevy_example_4_lib::boxes::PlayerId { methods::production_game_app::own_player_id(self) }
    pub fn box_spawns(&mut self) -> Vec<(freenet_libp2p_bevy_example_4_lib::boxes::PlayerId, bevy::math::Vec2, bool)> { methods::production_game_app::box_spawns(self) }
    pub fn remote_snapshots(&mut self) -> Vec<(freenet_libp2p_bevy_example_4_lib::boxes::PlayerId, bevy::math::Vec2, u64)> { methods::production_game_app::remote_snapshots(self) }
    pub fn state_hash(&self) -> u64 { methods::production_game_app::state_hash(self) }
    pub fn divergence_count(&self) -> u64 { methods::production_game_app::divergence_count(self) }
    ...
    pub async fn wait_for_box_ids(&mut self, expected: &[freenet_libp2p_bevy_example_4_lib::boxes::PlayerId], timeout: std::time::Duration) -> Result<(), String> {
        methods::production_game_app::wait_for_box_ids(self, expected, timeout).await
    }
    pub async fn wait_for_roster_ids(&mut self, expected: &[freenet_libp2p_bevy_example_4_lib::boxes::PlayerId], timeout: std::time::Duration) -> Result<(), String> {
