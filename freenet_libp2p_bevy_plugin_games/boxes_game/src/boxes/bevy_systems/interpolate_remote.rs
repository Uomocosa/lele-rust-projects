...
pub fn interpolate_remote(
    ...
    let window_secs = p2p::INTERPOLATION_WINDOW_MS as f32 / 1000.0;
...
mod tests {
    ...
    fn test_usage() {
        ...
        let entity = app
            .world_mut()
            .spawn((
                boxes::Player(net_id::NetworkId(7)),
            ...
            .id();
        app.add_systems(Update, interpolate_remote);
