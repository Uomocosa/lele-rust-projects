...
mod is_methods_dispatch;
mod is_real_constructor;
mod is_short_body;
...
pub(crate) use is_methods_dispatch::is_methods_dispatch;
pub(crate) use is_real_constructor::is_real_constructor;
