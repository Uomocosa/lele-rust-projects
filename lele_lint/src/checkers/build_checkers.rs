...
pub fn build_checkers(config: &Config) -> Vec<Box<dyn Checker>> {
    ...
    no_dunder_tests::NoDunderTests::register(&mut checkers, config);
    ...
    no_super_imports::NoSuperImports::register(&mut checkers, config);
