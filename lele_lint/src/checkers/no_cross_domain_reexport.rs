...
use super::no_cross_domain_reexport_meta;
...
impl Checker for NoCrossDomainReexport {
    fn name(&self) -> &'static str { no_cross_domain_reexport_meta::name(self) }
    fn code(&self) -> &'static str { no_cross_domain_reexport_meta::code(self) }
