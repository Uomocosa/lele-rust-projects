...
What example_4 does **differently** from example_2, and the goals / non-goals that shape it.
...
## What example_4 wants differently
...
- **In example_4** the *game rules* become the shared authority too, via a single **deterministic
...
- Real-time sequencing with a trusted single authority; example_4 is symmetric p2p with
