    ...
    app.add_systems(Startup, clicker::bevy_systems::setup)
        ...
        .add_systems(
            ...
            (
                ...
                clicker::bevy_systems::absorb_join_commit,
                clicker::bevy_systems::absorb_sync,
                clicker::bevy_systems::decide_join_commit,
                clicker::bevy_systems::spawn_pending_join,
                clicker::bevy_systems::reveal_on_join,
                clicker::bevy_systems::tick_join_countdown,
